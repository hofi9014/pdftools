...
const csp = [
  ...
  "img-src 'self' data: blob: https://www.google.com https://www.dropbox.com https://p.sfx.ms https://*.microsoftpersonalcontent.com",
  "media-src 'self' data: blob:",
  "worker-src 'self' blob:",
  "connect-src 'self' https://openrouter.ai https://www.googletagmanager.com https://*.google-analytics.com https://analytics.google.com https://apis.google.com https://accounts.google.com https://www.googleapis.com https://content.dropboxapi.com https://*.dropboxusercontent.com https://api.onedrive.com https://graph.microsoft.com https://my.microsoftpersonalcontent.com https://*.microsoftpersonalcontent.com",
