...
export default function ExtractPages({ locale: forcedLocale }: { locale?: Locale } = {}) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const blob = await downloadPdf(result, 'wybrane-strony.pdf');
    ...
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      {success && processedBlobRef.current && (
        <div className="flex justify-center mb-6">
          <CloudFileSaver blob={processedBlobRef.current} fileName="wybrane-strony.pdf" />
        </div>
      )}
