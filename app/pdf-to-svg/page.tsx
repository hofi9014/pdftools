  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <div className="text-center mb-10">
        <div className="text-6xl mb-4">{getToolIcon('svg')}</div>
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold tool-heading mb-3">{t('tool.svg', locale)}</h1>
      ...
      <div className="tool-info-box rounded-2xl p-5 mb-6">
        ...
        <p className="text-sm text-blue-700 dark:text-blue-300">{t('page.svg.local_desc', locale)}</p>
      </div>
      ...
      <button onClick={handleSubmit} disabled={loading || !file}
        ...
        {loading ? `⏳ ${t('btn.loading', locale)}` : `🖼️ ${t('page.svg.btn', locale)}`}
      </button>
